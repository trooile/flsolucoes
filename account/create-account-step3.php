...
<div class="position-relative m-4">
    ...
    <a role="button" class="position-absolute top-0 start-100 translate-middle btn btn-sm btn-primary rounded-pill" href="create-account-step3.php" style="width: 2rem; height:2rem;">3</a>
</div>
<div class="container">
